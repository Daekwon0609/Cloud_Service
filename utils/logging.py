...
async def Add_log(channel: discord.TextChannel, user: discord.User, user2: discord.User, bot: discord.Client, log_bool: bool):
    if log_bool:
        LOGS = []
        badwords = {"*": "", "─": "", "`": ""}
        ...
        await log_channel.send(f"**{user2}**님이 **N/A**님의 **N/A 타입**의 문의를 종료하였습니다.")
